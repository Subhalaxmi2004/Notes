"use client"
import { LucideIcon ,ChevronRight,ChevronDown,Plus,MoreHorizontal,Trash} from "lucide-react";
...
const Item = ({ label, onClick, icon: Icon,id,active,documentIcon,isSearch,level=0,onExpand,expanded }: ItemProps) => {
  ...
  return (
    <div
      ...
      className={cn("group min-h-[27px] text-sm py-1 pr-3 w-full hover:bg-primary/5  flex items-center text-muted-foreground font-medium",
        active && "bg-primary/5 rext-primary"
      )}
    >
      {
        !!id && (
